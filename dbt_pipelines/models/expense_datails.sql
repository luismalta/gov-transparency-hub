...
with expense_details as (
    ...
    SELECT
        ...
        "ano" AS "ano",
        "tipo" AS "tipo",
        TO_DATE("data_do_empenho", 'DD/MM/YYY') AS "data_empenho",
        TO_DATE("liquidac_a_o", 'DD/MM/YYY') AS "data_liquidacao",
        TO_DATE("pagamento", 'DD/MM/YYY') AS "data_pagamento",
        "unidade" AS "unidade",
        "func_a_o" AS "funcao",
    ...
    FROM
    {{ source('dagster', 'expense_details') }}
