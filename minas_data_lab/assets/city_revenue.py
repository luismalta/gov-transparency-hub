...
from minas_data_lab.assets.constants import CITY_REVENUE_COLUMNS_RENAME
...
def city_revenue(context, s3_resource: S3Resource, postgres_resource: PostgresResource):
    ...
    city_revenue_df.query('not Data.str.contains("TOTAL")', engine='python', inplace=True)
    city_revenue_df.query('not Data.str.contains("Total do Dia")', engine='python', inplace=True)
